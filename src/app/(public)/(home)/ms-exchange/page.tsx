...
export default function MsExchange() {
  return (
    <>
      <header className="relative header w-full h-[480px]">
        ...
        <div className=" w-full h-[300px] pt-12 flex items-center justify-center text-white flex-col">
          <h1 className="font-bold text-[3rem]">Eleve à sua empresa ao proximo nível</h1>
          <p className="text-[1.4rem]">Explore os nossos planos Microsoft Exchange</p>
          {/* <SearchBar /> */}
          <TldsPricesCard>
            {data.map((item) => (
              <div
