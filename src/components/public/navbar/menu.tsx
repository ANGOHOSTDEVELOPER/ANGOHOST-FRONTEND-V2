    ...
    return (
        <div className="p-2 rounded-md ">
            <NavigationMenu>
                <NavigationMenuList>
                    <NavigationMenuItem>
                        <NavigationMenuTrigger className="text-white hover:bg-transparent bg-transparent">Domínio</NavigationMenuTrigger>
                        <NavigationMenuContent>
                            <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                <ListItem className="flex flex-col items-center justify-center" href="/dominios" title="Registro de domínio">
                                    <div className="w-full flex items-center justify-center">
                                        <Image height={50} width={40} src={dominio} alt="" />
                                    </div>
                                ...
                                <ListItem className="flex flex-col items-center justify-center" href="/transferencia_de_dominios" title="Transferencia de domínio">
                                    <div className="w-full flex items-center justify-center">
                                        <Image height={50} width={40} src={transferencia_dominio} alt="" />
                                    </div>
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuTrigger className="text-white hover:bg-transparent bg-transparent">VPS</NavigationMenuTrigger>
                        <NavigationMenuContent>
                            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                                {components.map((component) => (
                                    ...
                                    >
                                        ...
                                        <Image height={50} width={50} className="w-[50px]" src={component.url} alt="" />
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuTrigger className="text-white hover:bg-transparent bg-transparent">Hospedagem</NavigationMenuTrigger>
                        <NavigationMenuContent>
                            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuTrigger className="text-white hover:bg-transparent bg-transparent">Revenda</NavigationMenuTrigger>
                        <NavigationMenuContent>
                            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuTrigger className="text-white hover:bg-transparent bg-transparent">SSL</NavigationMenuTrigger>
                        <NavigationMenuContent>
                            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuTrigger className="text-white hover:bg-transparent bg-transparent">E-Mail</NavigationMenuTrigger>
                        <NavigationMenuContent>
                            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                    ...
                    <NavigationMenuItem>
                        <NavigationMenuTrigger className="text-white hover:bg-transparent bg-transparent">Contactos</NavigationMenuTrigger>
                        <NavigationMenuContent>
                            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] ">
                    ...
                    <NavigationMenuItem>
                        {isAuth() ? 
                            <NavAvatar user={{name: 'Elisandro Franco', email: 'elisandro@franco.com', avatar: `${<User/>}`}}/>
                            :
                            <Link href={'/auth/sign-in'} className="rounded-[12px] border border-white w-[100px] h-[45px] flex items-center text-sm justify-center gap-4 text-white">
                                Entrar
                            </Link>
                        }
                    </NavigationMenuItem>
