...
const components: {
  ...
  },
  {
    ...
    description: "Tecnologia Virtulizor dedicada Windows VPS.",
  },
];
...
const hostingData: {
...
}[] = [
  {
    ...
    description: "Excelente escolha para sites baseados em PHP e MySQL.",
  },
  {
  ...
  },
  {
    ...
    description: "Uma escolha popular para desenvolvedores ASP e ASP.NET",
  },
];
...
const revendaData: {
  ...
  },
  {
    ...
    href: "/revenda-de-hospedagem",
    url: "https://www.squarebrothers.com/images/icon/windows-hosting.svg",
    description: "Comece seu negócio de hospedagem com Plesk hoje",
  },
];
...
const sslData: {
...
}[] = [
  {
    ...
    description: "SSL DV com melhor preço para seus sites.",
  },
];
...
const emailData: {
...
}[] = [
  {
    ...
    description: "Melhor hospedagem de e-mail empresarial acessível.",
  },
  {
    title: "Microsoft 365",
...
const contactData: {
...
}[] = [
  {
    ...
    description: "Nossos representantes ao vivo estão disponíveis no chat 24/7",
  },
  {
    title: "Whatsapp",
  ...
  return (
    <div className="p-2 rounded-md ">
      <NavigationMenu>
        <NavigationMenuList>
          <NavigationMenuItem>
            <NavigationMenuTrigger className="text-white hover:bg-transparent bg-transparent">
              Domínio
            </NavigationMenuTrigger>
            <NavigationMenuContent>
              <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                ...
                <ListItem
                  className="flex flex-col items-center justify-center"
                  href="/transferencia_de_dominios"
                  title="Transferencia de domínio"
                >
                  <div className="w-full flex items-center justify-center">
                    <Image
                      height={50}
                      width={40}
                      src={transferencia_dominio}
                      alt=""
                    />
                  </div>
                  Transfira seus domínios existentes para nós e economize
                  dinheiro!
                </ListItem>
              </ul>
            </NavigationMenuContent>
          ...
          <NavigationMenuItem>
            {isAuth() ? (
              ...
              <Link
                href={"/auth/sign-in"}
                className="rounded-[12px] border border-white w-[100px] h-[45px] flex items-center text-sm justify-center gap-4 text-white"
              >
                Entrar
              </Link>
            )}
          ...
          <NavigationMenuItem>
            <Link href="/cart">
              <Button
                type="button"
                className="bg-primary text-white flex justify-center items-center px-5 py-2 rounded-lg"
              >
